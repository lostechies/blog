...
[<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="image" src="http://lostechies.com/gabrielschenker/files/2014/04/image_thumb.png" width="369" height="242" />](http://lostechies.com/gabrielschenker/files/2014/04/image.png)
...
[<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="clip_image002[5]" src="http://lostechies.com/gabrielschenker/files/2014/04/clip_image0025_thumb.png" width="297" height="36" />](http://lostechies.com/gabrielschenker/files/2014/04/clip_image0025.png) 

and this is what you should see 

[<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="image" src="http://lostechies.com/gabrielschenker/files/2014/04/image_thumb1.png" width="917" height="534" />](http://lostechies.com/gabrielschenker/files/2014/04/image1.png) 

The Selenium server will start and (by default) listen at port 4444 (<http://localhost:4444/wd/hub>) 

To verify that Selenium is indeed up and working you can navigate with your browser to the above link. You should see the following [<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="image" src="http://lostechies.com/gabrielschenker/files/2014/04/image_thumb2.png" width="603" height="341" />](http://lostechies.com/gabrielschenker/files/2014/04/image2.png) 
...
[<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="clip_image001[7]" src="http://lostechies.com/gabrielschenker/files/2014/04/clip_image0017_thumb.png" width="361" height="158" />](http://lostechies.com/gabrielschenker/files/2014/04/clip_image0017.png) 

And then add %JAVA_HOME%\bin to your PATH variable 

[<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="clip_image002[7]" src="http://lostechies.com/gabrielschenker/files/2014/04/clip_image0027_thumb.png" width="361" height="158" />](http://lostechies.com/gabrielschenker/files/2014/04/clip_image0027.png) 
...
Note: if you want to start the Selenium stand-alone server from any location then you need to make sure that either 
  ...
  * the chrome driver binary is in the Path (ChromeDriver.exe) or 
    ...
    [<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="clip_image001[11]" src="http://lostechies.com/gabrielschenker/files/2014/04/clip_image00111_thumb.png" width="424" height="91" />](http://lostechies.com/gabrielschenker/files/2014/04/clip_image00111.png) 
    
    And the view (**index.html**) is defined as follows 
    
    [<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="image" src="http://lostechies.com/gabrielschenker/files/2014/04/image_thumb3.png" width="817" height="369" />](http://lostechies.com/gabrielschenker/files/2014/04/image3.png) 
    
    If we run this application then we can enter our first name into the input box and Angular will greet us. 
    
    [<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;margin: 0px;border-left: 0px;padding-right: 0px" border="0" alt="clip_image001[13]" src="http://lostechies.com/gabrielschenker/files/2014/04/clip_image00113_thumb.png" width="244" height="58" />](http://lostechies.com/gabrielschenker/files/2014/04/clip_image00113.png) 
    ...
    [<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="clip_image002[11]" src="http://lostechies.com/gabrielschenker/files/2014/04/clip_image00211_thumb.png" width="578" height="177" />](http://lostechies.com/gabrielschenker/files/2014/04/clip_image00211.png) 
    ...
    **Also note**: on line 3 you need to put the full URL e.g.  
    ...
    [<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="image" src="http://lostechies.com/gabrielschenker/files/2014/04/image_thumb4.png" width="811" height="328" />](http://lostechies.com/gabrielschenker/files/2014/04/image4.png) 
    
    Add the following snippet under the **<div>** 
    
    [<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;margin: 0px 0px 24px;border-left: 0px;padding-right: 0px" border="0" alt="clip_image001[15]" src="http://lostechies.com/gabrielschenker/files/2014/04/clip_image00115_thumb.png" width="915" height="130" />](http://lostechies.com/gabrielschenker/files/2014/04/clip_image00115.png) 
    
    Add a file **app.js** to the project and add this code to define a controller. 
    
    [<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="image" src="http://lostechies.com/gabrielschenker/files/2014/04/image_thumb5.png" width="580" height="112" />](http://lostechies.com/gabrielschenker/files/2014/04/image5.png) 
    
    Now define the **loadStaff** function in the controller 
    
    [<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="clip_image002[13]" src="http://lostechies.com/gabrielschenker/files/2014/04/clip_image00213_thumb.png" width="609" height="227" />](http://lostechies.com/gabrielschenker/files/2014/04/clip_image00213.png) 
    ...
    [<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="image" src="http://lostechies.com/gabrielschenker/files/2014/04/image_thumb6.png" width="973" height="271" />](http://lostechies.com/gabrielschenker/files/2014/04/image6.png) 
    ...
    [<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="image" src="http://lostechies.com/gabrielschenker/files/2014/04/image_thumb7.png" width="980" height="272" />](http://lostechies.com/gabrielschenker/files/2014/04/image7.png) 
    ...
    [<img style="border-top: 0px;border-right: 0px;border-bottom: 0px;padding-top: 0px;padding-left: 0px;border-left: 0px;padding-right: 0px" border="0" alt="clip_image002[15]" src="http://lostechies.com/gabrielschenker/files/2014/04/clip_image00215_thumb.png" width="736" height="421" />](http://lostechies.com/gabrielschenker/files/2014/04/clip_image00215.png) 
