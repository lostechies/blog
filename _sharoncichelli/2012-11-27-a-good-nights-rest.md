...
[<img src="http://lostechies.com/sharoncichelli/files/2012/11/sleepScheduledTask1-300x223.png" alt="Create Task in Windows Task Scheduler" width="300" height="223" class="aligncenter size-medium wp-image-145" />](/content/sharoncichelli/uploads/2012/11/sleepScheduledTask1.png)

[<img src="http://lostechies.com/sharoncichelli/files/2012/11/sleepScheduledTaskAction-277x300.png" alt="Create new Action, set action type to Run a Program, enter PowerShell as the command" width="277" height="300" class="aligncenter size-medium wp-image-134" />](/content/sharoncichelli/uploads/2012/11/sleepScheduledTaskAction.png)
