...
d:codegitk-demo&gt;gitk --all</pre>
 ...
 <img style="border-right-width: 0px;border-top-width: 0px;border-bottom-width: 0px;border-left-width: 0px" border="0" alt="gitk overview" src="http://lostechies.com/joshuaflanagan/files/2011/03/gitkgitkdemo_20100903_111430_57888BE7.png" width="740" height="616" />
...
Press CTRL-F5 in the gitk window to refresh the repository view
 ...
 <img style="border-right-width: 0px;border-top-width: 0px;border-bottom-width: 0px;border-left-width: 0px" border="0" alt="created branch" src="http://lostechies.com/joshuaflanagan/files/2011/03/gitkgitkdemo_20100903_115938_213763D8.png" width="744" height="620" />
...
(We’re going to focus on information in the top pane from now on, so I’ll hide the bottom part of gitk)
 ...
 <img style="border-right-width: 0px;border-top-width: 0px;border-bottom-width: 0px;border-left-width: 0px" border="0" alt="changed branch" src="http://lostechies.com/joshuaflanagan/files/2011/03/gitkgitkdemo_20100903_121554_54FF5A29.png" width="744" height="373" />
...
<pre><img style="border-right-width: 0px;border-top-width: 0px;border-bottom-width: 0px;border-left-width: 0px" border="0" alt="Commit moves current branch pointer" src="http://lostechies.com/joshuaflanagan/files/2011/03/gitkgitkdemo_20100903_123037_2639A187.png" width="744" height="373" /> </pre>
...
[issue123 cac3c72] Added another fruit
 ...
 <img style="border-right-width: 0px;border-top-width: 0px;border-bottom-width: 0px;border-left-width: 0px" border="0" alt="More commits move current branch" src="http://lostechies.com/joshuaflanagan/files/2011/03/gitkgitkdemo_20100903_131205_534E8E55.png" width="744" height="373" />
...
Since I was working in a branch, I expected to see a tree stucture, with nodes turning off from the main “trunk”. Something like this:
 ...
 <img style="border-right-width: 0px;border-top-width: 0px;border-bottom-width: 0px;border-left-width: 0px" border="0" alt="Expected branch visualization" src="http://lostechies.com/joshuaflanagan/files/2011/03/expected_tree_2488D5B3.png" width="238" height="183" />
...
<img style="border-right-width: 0px;border-top-width: 0px;border-bottom-width: 0px;border-left-width: 0px" border="0" alt="Back on master, preparing for merge" src="http://lostechies.com/joshuaflanagan/files/2011/03/gitkgitkdemo_20100903_145555_5D337FC0.png" width="744" height="373" />&#160;
...
<strong>Fast-forward</strong>
 ...
 <img style="border-right-width: 0px;border-top-width: 0px;border-bottom-width: 0px;border-left-width: 0px" border="0" alt="After fast forward merge" src="http://lostechies.com/joshuaflanagan/files/2011/03/gitkgitkdemo_20100903_150024_2A63794C.png" width="744" height="373" />
...
<pre><img style="border-right-width: 0px;border-top-width: 0px;border-bottom-width: 0px;border-left-width: 0px" border="0" alt="After branch deleted" src="http://lostechies.com/joshuaflanagan/files/2011/03/gitkgitkdemo_20100903_151810_4286E3A7.png" width="744" height="373" /> </pre>
...
[<img style="border-right-width: 0px;border-top-width: 0px;border-bottom-width: 0px;border-left-width: 0px" border="0" alt="Commit History on GitHub" src="http://lostechies.com/joshuaflanagan/files/2011/03/CommitHistoryforjoshuaflanagansgitkdemoGitHubGoogleChrome_20100903_153022_thumb_12E8C51B.png" width="644" height="230" />](http://lostechies.com/joshuaflanagan/files/2011/03/CommitHistoryforjoshuaflanagansgitkdemoGitHubGoogleChrome_20100903_153022_5AAA4E02.png) 
